...
class NSPredicateMPTests: XCTestCase {
    func testNot() {
        let predicate = NSPredicate(value: true)
        let notPredicate = predicate.mp.not
    ...
    func testAndPredicate() {
        ...
        let andPredicate = predicate1.mp.and(predicate2)
    ...
    func testOrPredicate() {
        let predicate1 = NSPredicate(value: true)
        let predicate2 = NSPredicate(value: false)
        let orPredicate = predicate1.mp.or(predicate2)
