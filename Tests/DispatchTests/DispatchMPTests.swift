...
final class DispatchMPTests: XCTestCase {
    ...
    func testAsyncAfter() {
        ...
        DispatchQueue.main.mp.asyncAfter(delay: delay) {
    ...
    func testDebounce() {
        ...
        let delay = 0.02
        let debouncedIncrementor = DispatchQueue.main.mp.debounce(delay: delay) {
            value += 1
        }
