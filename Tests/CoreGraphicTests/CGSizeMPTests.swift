...
class CGSizeMPTests: XCTestCase {
    func testAspectFit() {
    ...
    func testAspectRatio() {
        ...
        XCTAssertEqual(size1.mp.aspectRatio, 0)

        let size2 = CGSize(width: 20, height: 10)
        XCTAssertEqual(size2.mp.aspectRatio, 2)
    }

    func testMaxDimension() {
        let size1 = CGSize(width: 10, height: 0)
        XCTAssertEqual(size1.mp.maxDimension, 10)

        let size2 = CGSize(width: 20, height: 40)
        XCTAssertEqual(size2.mp.maxDimension, 40)
    }

    func testMinDimension() {
        let size1 = CGSize(width: 10, height: 0)
        XCTAssertEqual(size1.mp.minDimension, 0)

        let size2 = CGSize(width: 20, height: 40)
        XCTAssertEqual(size2.mp.minDimension, 20)
    }
