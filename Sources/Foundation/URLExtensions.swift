...
public extension MapleWrapper where Base == URL {
    ...
    ///        url.mp.appendingQueryParameters(params) -> "https://google.com?q=Swifter%20Swift"
    ///
    ...
    ///    url.mp.queryValue(for: "code") -> "12345"
    ///
    ...
    ///     url.mp.deletingAllPathComponents() // "https://domain.com/"
    ///
    ...
    ///        url.mp.droppedScheme() // "domain.com"
