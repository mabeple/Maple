...
public extension MapleWrapper where Base == String {
    ...
    ///
    ///     "SGVsbG8gV29ybGQh".mp.base64Decoded -> Optional("Hello World!")
    ///
    ...
    ///
    ///        "Hello World!".mp.base64Encoded -> Optional("SGVsbG8gV29ybGQh")
    ///
    ...
    ///
    ///        "https://google.com".mp.isValidUrl -> true
    ///
    var isValidUrl: Bool {
        URL(string: base) != nil
    }
    ...
    ///
    ///        "john@doe.com".mp.isValidEmail -> true
    ///
    ...
    ///
    ///        "https://google.com".mp.isValidSchemedUrl -> true
    ///        "google.com".mp.isValidSchemedUrl -> false
    ///
    ...
    ///
    ///        "https://google.com".mp.isValidHttpsUrl -> true
    ///
    ...
    ///
    ///        "http://google.com".mp.isValidHttpUrl -> true
    ///
    ...
    ///
    ///        "file://Documents/file.txt".mp.isValidFileUrl -> true
    ///
    ...
    ///
    ///     "123".mp.isDigits -> true
    ///     "1.3".mp.isDigits -> false
    ///     "abc".mp.isDigits -> false
    ///
    var isDigits: Bool {
    ...
    ///
    ///        "https://google.com".mp.url -> URL(string: "https://google.com")
    ///        "not url".mp.url -> nil
    ///
    var url: URL? {
        URL(string: base)
    ...
    ///
    ///        "it's%20easy%20to%20decode%20strings".mp.urlDecoded -> "it's easy to decode strings"
    ///
    ...
    /// URL escaped string.
    ///
    ///        "it's easy to encode strings".mp.urlEncoded -> "it's%20easy%20to%20encode%20strings"
    ///
...
public extension MapleWrapper where Base == String {
    ...
    ///
    ///        "SomeText".mp.copyToPasteboard() // copies "SomeText" to pasteboard
    ///
    ...
    ///
    ///        "Hello World!".mp.contains("O") -> false
    ///        "Hello World!".mp.contains("o", caseSensitive: false) -> true
    ///
    /// - Parameters:
    ...
    ///
    ///        let str = "sOme vaRiabLe Name"
    ///        str.mp.camelize() // "someVariableName"
    ///
    ...
    ///
    ///        "Hello World!".mp.count(of: "o") -> 2
    ///        "Hello World!".mp.count(of: "L", caseSensitive: false) -> 3
    ///
    /// - Parameters:
    ///   - string: substring to search for.
    ///   - caseSensitive: set true for case sensitive search (default is true).
    ...
    ///
    ///        "2017-01-15".mp.date(withFormat: "yyyy-MM-dd") -> Date set to Jan 15, 2017
    ///        "not date string".mp.date(withFormat: "yyyy-MM-dd") -> nil
    ///
    ...
    ///
    ///   "Hello, World!".mp.removingPrefix("Hello, ") -> "World!"
    ///
    ...
    ///
    ///   "Hello, World!".mp.removingSuffix(", World!") -> "Hello"
    ///
